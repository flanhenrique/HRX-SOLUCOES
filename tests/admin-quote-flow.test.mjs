...
test('gerador segue a Proposta Comercial Opção 3 Revisada em seis páginas fixas', async () => {
  ...
  assert.match(pdf, /Estrutura fixa aprovada: 6 páginas/)
  ...
  assert.match(pdf, /const pages = \[drawCover, drawPresentation, drawScope, drawInvestment, drawConditions, drawAcceptance\]/)
